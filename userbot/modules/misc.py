...
async def reedme(event):
    await edit_or_reply(
        ...
        "\n✣ [List Variabel Heroku untuk Mikoo-Userbot](https://telegra.ph/List-Variabel-Heroku-untuk-Mikoo-Userbot-09-22)"
        "\n✣ [Setup Guide - Basic](https://divarvian.medium.com/cara-memasang-userbot-telegram-repo-Mikoo-Userbot-deploy-di-heroku-c56d1f8b5537)"
...
async def repo_is_here(event):
    ...
    await xx.edit(
        ...
        f"✣ **Group Support :** [Sharing Userbot](t.me/MikooUserbot)\n"
        f"✣ **Channel Man :** [MikooUserbot](t.me/MikooUserbot)\n"
...
async def string_is_here(event):
    await edit_or_reply(
        event,
        "✥ **GET STRING SESSION TELEGRAM :** [KLIK DISINI](https://repl.it/@divarvian/stringenSession?lite=1&outputonly=1)\n",
    )
