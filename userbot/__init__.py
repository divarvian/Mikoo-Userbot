...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/divarvian/Reforestation/master/DEVS.json"
    )
...
# Support
GROUP = os.environ.get("GROUP", "MikooUserbot")
CHANNEL = os.environ.get("CHANNEL", "MikooUserbot")
...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL", "https://github.com/divarvian/Mikoo-Userbot.git"
)
...
# Bot version
BOT_VER = os.environ.get("BOT_VER", "1.8.0")
...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/divarvian/Reforestation/master/manblacklist.json"
    )
...
ch = str(b64decode("QE1pa29vVXNlcmJvdA=="))
gc = str(b64decode("QE1pa29vVXNlcmJvdA=="))

while 0 < 6:
    _WHITELIST = get(
        "https://raw.githubusercontent.com/divarvian/Reforestation/master/whitelist.json"
    )
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Mikoo-Userbot v{BOT_VER} is back up and running!**\n\n"
...
with bot:
    try:
        ...
        async def inline_handler(event):
            ...
            result = None
            query = event.text
            if event.query.user_id == uid and query.startswith("@MikooUserbot"):
                buttons = paginate_help(0, dugmeler, "helpme")
                result = builder.photo(
                    file=logoman,
                    link_preview=False,
                    text=f"**✗ Mikoo-Userbot Inline Menu ✗**\n\n✣ **Owner** [{user.first_name}](tg://user?id={user.id})\n✣ **Jumlah** `{len(dugmeler)}` Modules",
                    buttons=buttons,
                )
            elif query.startswith("repo"):
                result = builder.article(
                    title="Repository",
                    description="Repository Mikoo - Userbot",
                    url="https://t.me/MikooUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text="**Mikoo - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **Owner Repo :** [DivaArvian](https://t.me/divarvian)\n✣ **Support :** @MikooUserbot\n✣ **Repository :** [Mikoo-Userbot](https://github.com/divarvian/Mikoo-Userbot)\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("Group", "https://t.me/MikooUserbot"),
                            custom.Button.url(
                ...
                result = builder.article(
                    title="✗ Mikoo-Userbot ✗",
                    description="Mikoo - UserBot | Telethon",
                    url="https://t.me/MikooUserbot",
                    thumb=InputWebDocument(INLINE_PIC, 0, "image/jpeg", []),
                    text=f"**Mikoo - UserBot**\n➖➖➖➖➖➖➖➖➖➖\n✣ **UserMode:** [{user.first_name}](tg://user?id={user.id})\n✣ **Assistant:** {tgbotusername}\n➖➖➖➖➖➖➖➖➖➖\n**Support:** @MikooUserbot\n➖➖➖➖➖➖➖➖➖➖",
                    buttons=[
                        [
                            custom.Button.url("Group", "https://t.me/MikooUserbot"),
                            custom.Button.url(
